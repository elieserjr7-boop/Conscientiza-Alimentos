    ...
    if submitted:
        ...
        if nome_pessoa and rua and bairro and numero_casa and numero_contato and descricao_alimentos:
            if enviar_email(nome_pessoa, endereco_completo, numero_contato, descricao_alimentos):
                ...
                st.link_button("Compartilhar no WhatsApp", "https://wa.me/?text=Estou%20ajudando%20a%20combater%20o%20desperdício%20de%20alimentos%20com%20o%20projeto%20Alimento%20Salvo%20em%20Ipiranga/PI!%20Conheça%20você%20também:%20[link-do-seu-app-aqui]")
            else:
